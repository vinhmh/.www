...
do
  ...
  sudo systemctl restart textchat-node
done
```
...
```
[Unit]
Description=Textchat Nodejs server
...
User=app
ExecStart=/home/app/.nvm/versions/node/v10.6.0/bin/node textchat-node/dist/bin/server.js
RestartSec=500ms
...
sudo systemctl enable textchat-node
sudo systemctl start textchat-node
```
